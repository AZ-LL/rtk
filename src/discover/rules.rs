...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"(?i)^(?:RunUAT(?:\.(?:sh|bat|cmd))?|.*[\\/]RunUAT(?:\.(?:sh|bat|cmd))?)\b",
        rtk_cmd: "rtk unreal uat",
        rewrite_prefixes: &["RunUAT.sh", "RunUAT.bat", "RunUAT.cmd", "RunUAT"],
        category: "Build",
        savings_pct: 85.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"(?i)^(?:RunUBT(?:\.(?:sh|bat|cmd))?|.*[\\/]RunUBT(?:\.(?:sh|bat|cmd))?|.*[\\/]Engine[\\/]Build[\\/]BatchFiles(?:[\\/]\w+)?[\\/]Build\.(?:sh|bat)|Build\.(?:sh|bat)\s+\S+\s+(?:Linux|Win64|Mac|Android|IOS)\s+(?:Development|DebugGame|Shipping|Test))\b",
        rtk_cmd: "rtk unreal build",
        rewrite_prefixes: &[
            "RunUBT.sh",
            "RunUBT.bat",
            "RunUBT.cmd",
    ...
    RtkRule {
        pattern: r"(?i)^(?:UnrealEditor-Cmd(?:\.exe)?|.*[\\/]UnrealEditor-Cmd(?:\.exe)?)\b",
        rtk_cmd: "rtk unreal commandlet",
        rewrite_prefixes: &["UnrealEditor-Cmd", "UnrealEditor-Cmd.exe"],
        category: "Build",
        savings_pct: 85.0,
        subcmd_savings: &[],
        subcmd_status: &[],
